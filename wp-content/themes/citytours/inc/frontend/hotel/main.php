...
add_action( 'wp_ajax_jk_hotel_update_cart', 'jk_hotel_update_cart' );
add_action( 'wp_ajax_nopriv_jk_hotel_update_cart', 'jk_hotel_update_cart' );

add_action( 'wp_ajax_jk_hotel_remove_cart', 'jk_hotel_remove_cart' );
add_action( 'wp_ajax_nopriv_jk_hotel_remove_cart', 'jk_hotel_remove_cart' );