		...
		<div class="wrap">
			...
			<form method="post" onsubmit="return manage_vacancy_validateForm();">
				...
				<table class="ct_admin_table ct_hotel_vacancy_manage_table">
					...
					<tr>
						<th>Weekend Price Friday</th>
						<td><input type="text" name="weekend_price_fri" value="<?php if ( ! empty( $vacancy_data['weekend_price_fri'] ) ) echo esc_attr( $vacancy_data['weekend_price_fri'] ); ?>"></td>
					</tr>
					<tr>
						<th>Weekend Price Saturday</th>
						<td><input type="text" name="weekend_price_sat" value="<?php if ( ! empty( $vacancy_data['weekend_price_sat'] ) ) echo esc_attr( $vacancy_data['weekend_price_sat'] ); ?>"></td>
					</tr>
					<tr>
						<th>Peakseason Price</th>
						<td><input type="text" name="peakseason_price" value="<?php if ( ! empty( $vacancy_data['peakseason_price'] ) ) echo esc_attr( $vacancy_data['peakseason_price'] ); ?>"></td>
					</tr>
				</table>
	...
	function ct_hotel_vacancy_save_action() {
		...
		if ( ! isset( $_POST['vacancy_save'] ) || ! wp_verify_nonce( $_POST['vacancy_save'], 'ct_hotel_vacancy_manage' ) ) {
		   ...
		   exit;
			...
			$table_fields = array( 'date_from', 'date_to', 'hotel_id', 'room_type_id', 'rooms', 'price_per_room', 'price_per_person', 'price_per_child','weekend_price_fri','weekend_price_sat','peakseason_price');
			$data = array();
