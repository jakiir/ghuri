...
$hotel_locations = get_terms( 'hotel_location', array( 'hide_empty' => false ) );
$locations = array( esc_html__( "All", "ct" ) => "" );
if ( ! is_wp_error( $hotel_locations ) ) :
foreach ( $hotel_locations as $term ) {
	$locations[$term->name] = $term->term_id;
}
endif;
...
vc_map( array(
	...
	"params" => array(
		...
		array(
			'type' => 'dropdown',
			'heading' => esc_html__( 'Locations', 'citytours' ),
			'param_name' => 'hotel_location',
			"dependency" => array(
				"element" => "type",
