...
if ( ! function_exists( 'ct_metabox_admin_enqueue_scripts' ) ) {
	function ct_metabox_admin_enqueue_scripts() {
		$screen = get_current_screen();
		if ( 'post' != $screen->base || ! in_array( $screen->post_type, array('tour', 'hotel') ) ) return;
	...
	function ct_hotel_register_meta_boxes() {
		...
		$meta_boxes[] = array(
			...
			'fields' => array(
				...
				array(
					'name'  => esc_html__( 'Max Extra Bed', 'citytours' ),
					'id'      => "{$prefix}max_extra_bed",
					'desc'  => esc_html__( 'This is maximum extra bed field', 'citytours' ),
					'type'  => 'number'
				),	
				array(
					'name'  => esc_html__( 'Per Extra Bed Price', 'citytours' ),
					'id'      => "{$prefix}per_extra_bed_price",
					'desc'  => esc_html__( 'Per Extra Bed Price', 'citytours' ),
					'type'  => 'number'					
				),	
				array(
				...
				array(
					'name' => esc_html__( 'Hotel Policy', 'citytours' ),
					'id'   => "{$prefix}hotel_policy",
					'type' => 'wysiwyg',
					'raw'  => true,
					'options' => array(
						'textarea_rows' => 4,
				...
				array(
					'name' => esc_html__( 'Additional Info', 'citytours' ),
				...
				array(
					'name'  => esc_html__( 'Amenities', 'citytours' ),
					'id'      => "{$prefix}amenities",
					'desc'  => esc_html__( 'Select Amenities', 'citytours' ),
					'type'  => 'taxonomy',
					'placeholder' => esc_html__( 'Select Amenities', 'citytours' ),
					'options' => array(
		...
		$meta_boxes[] = array(
			...
			'fields' => array(
				...
				array(
					'name'  => esc_html__( 'Discount Price', 'citytours' ),
					'id'    => "{$prefix}discount_price",
					'desc'  => esc_html__( 'Write discount in %', 'citytours' ),
					'type' => 'number',
					'std' => 0
				),				
				array(
					'name' => esc_html__( 'Extra Facilities', 'citytours' ),
					'id'    => "{$prefix}extra_facilities",
					'desc' => esc_html__( 'Select room extra facilities', 'citytours' ),
					'type'    => 'checkbox_list',
					'options' => array(
						'Breakfast included' => 'Breakfast included',
						'No Extra bed available' => 'No Extra bed available'						
					),
				),
				array(
					'name'  => esc_html__( 'Bed Details', 'citytours' ),
					'id'    => "{$prefix}bed_details",
					'desc'  => esc_html__( 'How many bed are in the room?', 'citytours' ),
					'type' => 'text',
					'std' => 0
				),				
				array(
					'name'  => esc_html__( 'Person', 'citytours' ),
					'id'    => "{$prefix}person",
					'desc'  => esc_html__( 'How many person are in the room?', 'citytours' ),
					'type' => 'number',
					'std' => 0
				),
				array(
					'name'  => esc_html__( 'Price', 'citytours' ),
					'id'    => "{$prefix}price",
					'desc'  => esc_html__( 'How many price are in the room?', 'citytours' ),
					'type' => 'number',
					'std' => 0
				),
				array(
