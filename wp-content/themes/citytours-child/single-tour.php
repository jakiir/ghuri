		...
		<div class="box_style_1 expose">
			...
			<form method="get" id="booking-form" action="<?php echo esc_url( ct_get_tour_cart_page() ); ?>">
				...
				<div class="row">
					<div class="col-md-6 col-sm-6">
						<div class="form-group">
							...
							<input class="date-pick form-control" data-date-format="<?php echo ct_get_date_format('html'); ?>" type="text" value="<?php echo $date; ?>" name="date">
						</div>
					</div>
				</div>
				<?php endif; ?>
					...
					<div class="col-md-6 col-sm-6">
						<div class="form-group">
							...
							<div class="numbers-row" data-min="1">
								<input type="text" value="<?php echo $adults; ?>" id="adults" class="qty2 form-control" name="adults">
							</div>
						</div>
					</div>
				...
				<tr>
					...
					<td class="text-right">						
						<span class="adults-number"><?php echo $adults; ?></span>x <?php echo ct_price( $person_price ) ?>
				...
				<tr class="total">
					...
					<td class="text-right total-cost">
						<?php $person_priced = $adults*$person_price; ?>
						<?php echo ct_price( $person_priced ) ?>
					</td>
				</tr>
				</tbody>
				</table>
...
$(document).ready(function(){
	...
	if ( $('input.date-pick').length ) {
		...
		var tour_date = getParameterByName('date') ? getParameterByName('date') : '';
		if(tour_date == ''){
