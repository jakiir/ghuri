...
$logo_url = $get_template_directory_ver.'/img/logo_sticky.png';
			...
			$mail->Subject = 'Confirmation of register in ghuri.online';			
			
			$senderEmail = (!empty($_REQUEST['email']) ? $_REQUEST['email'] : '');
			$partner_type = (!empty($_REQUEST['partner_type']) ? $_REQUEST['partner_type'] : '');
			$partnerMobile = (!empty($_REQUEST['mobile']) ? $_REQUEST['mobile'] : '');
			$partnerCountry = (!empty($_REQUEST['country']) ? $_REQUEST['country'] : '');
			$senderItemname = (!empty($_REQUEST['itemname']) ? $_REQUEST['itemname'] : '');
			if($senderEmail){
				$mail->addCC($senderEmail, $senderItemname);  // Add a recipient
			}
...
$message = '<html><body>';		
			...
			$message .= '<tr style="mso-yfti-irow:0;mso-yfti-firstrow:yes">  
			  ...
			  <div style="font-size:11px;font-weight:bold;">Thank you for your registration made through ghuri.online.</div>
			  </div>
			  </td>
			 </tr>
			  ...
			  mso-border-bottom-alt:solid #E6EDF6 .75pt;padding:0in 0in 16.75pt 0in">
			   ...
			   style="border:1px solid #85c99d;padding-top: 10px;">
				...
				<tr style="mso-yfti-irow:0;mso-yfti-firstrow:yes">
					...
					line-height:12.55pt"><b><span lang=EN-GB style="font-size:9.0pt;width:23%;display:inline-block;">Partner Type</span></b><span lang=EN-GB style="font-size:9.0pt;">  : '.$partner_type.'</span></p>
					</td>
				</tr>
				<tr style="mso-yfti-irow:0;mso-yfti-firstrow:yes">
					<td colspan="2" valign=top style="padding:0pt 3.0pt 2.35pt 10.05pt;width: 100%;">
					<p class=MsoNormal style="margin-bottom:0in;margin-bottom:.0001pt;
					line-height:12.55pt"><b><span lang=EN-GB style="font-size:9.0pt;width:23%;display:inline-block;">Partner Name</span></b><span lang=EN-GB style="font-size:9.0pt;">  : '.$senderName.'</span></p>
					</td>
				</tr>
				<tr style="mso-yfti-irow:0;mso-yfti-firstrow:yes">
					<td colspan="2" valign=top style="padding:0pt 3.0pt 2.35pt 10.05pt;width: 100%;">
					<p class=MsoNormal style="margin-bottom:0in;margin-bottom:.0001pt;
					line-height:12.55pt"><b><span lang=EN-GB style="font-size:9.0pt;width:23%;display:inline-block;">Partner Email</span></b><span lang=EN-GB style="font-size:9.0pt;">  : '.$senderEmail.'</span></p>
					</td>
				</tr>
				<tr style="mso-yfti-irow:0;mso-yfti-firstrow:yes">
					<td colspan="2" valign=top style="padding:0pt 3.0pt 2.35pt 10.05pt;width: 100%;">
					<p class=MsoNormal style="margin-bottom:0in;margin-bottom:.0001pt;
					line-height:12.55pt"><b><span lang=EN-GB style="font-size:9.0pt;width:23%;display:inline-block;">Partner Mobile</span></b><span lang=EN-GB style="font-size:9.0pt;"> : '.$partnerMobile.'</span></p>
					</td>
				</tr>
				<tr style="mso-yfti-irow:0;mso-yfti-firstrow:yes">
					<td colspan="2" valign=top style="padding:0pt 3.0pt 2.35pt 10.05pt;width: 100%;">
					<p class=MsoNormal style="margin-bottom:0in;margin-bottom:.0001pt;
					line-height:12.55pt"><b><span lang=EN-GB style="font-size:9.0pt;width:23%;display:inline-block;">Partner Country</span></b><span lang=EN-GB style="font-size:9.0pt;"> : '.$partnerCountry.'</span></p>
					</td>
				</tr>
			   </table>
			   </td>
