<?php
 /*
 Template Name: Booking confirmation pages
 */
...
$message = '<html><body>';		
			...
			if(!empty($order_rooms)){
				$cou = 1;
				foreach($order_rooms as $roomDetail){	
					$room_id = $roomDetail['room_type_id'];
					...
					$total_price_item = $roomDetail['total_price'];
					 ...
					 <td colspan="3">
					  ...
					  <table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0
					   ...
					   <tr>
						...
						<td width=79 valign=top style="width:59.5pt;padding:0;margin:0;">
						<p class=normal style="margin:0;"><span style="font-size:8.5pt;background:white;">'.$room_max_adults.' Adults</span></p>
						</td>
					   </tr>
					  </table>
					  </td>  
