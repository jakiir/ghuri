...
if($_REQUEST['locations'] !=''){
	...
	$options = "hotel_location_{$locationId}_images";
	$get_hotel_location_img = get_site_option( $options );
	$header_img_scr_location = esc_url( wp_get_attachment_url( $get_hotel_location_img ) );
	...
	<div class="row">
		...
		<div id="locations_search">
			...
			<div class="collapse" id="collapseLocations_search">
				<div class="Locations_search_wp">
					<?php if ( ! empty( $ct_options['hotel_location_filter'] ) ) :?>
					<div class="filter_type">
						...
						<ul class="list-filter location-filter" data-base-url="<?php echo esc_url( remove_query_arg( array( 'locations', 'page' ) ) ); ?>" data-arg="locations">
							...
							foreach ( $all_locations as $location ) {
								...
								echo '<li><label><input type="checkbox" name="hotel_location_filter[]" value="' . esc_attr( $term_id ) . '"' . $checked . '>' . esc_html( $location->name ) . '</label></li>';
							}
							endif;?>
						</ul>
					</div>
		...
		<div id="filters_col">
			...
			<div class="collapse" id="collapseFilters">
				...
				<?php $counts_by_star = ct_hotel_get_search_result_count( array( 'by' => 'star', 'price_filter'=>$price_filter, 'rating_filter'=>$rating_filter, 'facility_filter'=>$facility_filter, 'hotel_location' => $locations ) ); ?>
				<div class="filter_type">
				...
				<div class="filter_type">
					...
					<li><label><input type="checkbox" name="property_type_filter[]" value=""><span class="property_type">Motel</span></label></li>
