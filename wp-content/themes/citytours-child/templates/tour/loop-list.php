...
$pram['date'] = (isset($_GET['date']) ? $_GET['date'] : '');
$pram['adults'] = (isset($_GET['adults']) ? $_GET['adults'] : '');
$pram['kids'] = (isset($_GET['kids']) ? $_GET['kids'] : '');
$pram['tour_types'] = (isset($_GET['tour_types']) ? $_GET['tour_types'] : '');
$pram['tour_name'] = (isset($_GET['s']) ? $_GET['s'] : '');
...
$tourDetails = get_permalink( $post_id ).'?'.$and_separated;
...
<div class="strip_all_tour_list wow fadeIn" data-wow-delay="0.1s">
	<div class="row">
		<div class="col-lg-4 col-md-4 col-sm-4">
			...
			<?php endif; ?>
			<div class="img_list">
				<a href="<?php echo esc_url( $tourDetails ); ?>">
		...
		<div class="col-lg-3 col-md-3 col-sm-3">
			<div class="price_list">
				<div style="font-size: 24px;line-height: 27px;">
					BDT <?php echo $price; ?><small ><?php echo esc_html__( '*Per person', 'citytours' ) ?></small>
					<!--<p><a href="<?php //echo esc_url( get_permalink( $post_id ) ); ?>" class="btn_1"><?php echo esc_html__( 'Details', 'citytours' ) ?></a></p>-->
					<p><a href="<?php echo esc_url( $tourDetails ); ?>" class="btn_1 yellow"><?php echo esc_html__( 'Book now', 'citytours' ) ?></a></p>
				</div>
			</div>
		</div>
	</div>
