...
<div class="row">
	<div class="col-md-8">
		...
		<div class="step">
			...
			<?php 
			if($order_data['payment_method'] == 'bkash'){
				$bookingNo = ($_REQUEST['booking_no'] ? 'GH'.$_REQUEST['booking_no'] : 'GH****');
				echo esc_html__( 'Thank you for your reservation made through ghuri.online. We have emailed you the booking confirmation. Please pay via bkash to +88 01977717716 number and mention the booking reference ('.$bookingNo.') with in the next 72 hours. Otherwise your booking will be cancelled.' );
			}
			if($order_data['payment_method'] == 'pay_hotel'){
				echo esc_html__( 'Thank you for your reservation made through ghuri.online. We have emailed you the booking confirmation please print confirmation email and show it upon hotel check in.' );
			}
			?>
		...
		<div class="step">
			...
			<tr>
				<td><strong><?php echo esc_html__( 'Payment Methods', 'citytours' ) ?></strong></td>
	...
	<div class="box_style_1">
		...
		<!-- <p><?php echo esc_html__( 'We wish you a wonderful travel experience from ghuri.online.', 'citytours' ) ?></p> -->
		<?php if ( ! empty( $ct_options['hotel_thankyou_text_2'] ) ) : ?>
		<p><?php echo 'We wish you a wonderful travel experience from ghuri.online.'; //echo esc_html__( $ct_options['hotel_thankyou_text_2'], 'citytours' ) ?></p>
		<?php endif; ?>
		<hr>
		...
		<?php endif; */?>
		<a class="btn_full_outline" target="_blank" href="<?php echo esc_url( add_query_arg( array( 'booking_no' => $order_data['booking_no'], 'pin_code' => $order_data['pin_code'] ) ,home_url('/hotel-booking-confirmation/') ) ) ?>" target="_blank"><?php echo esc_html__( 'View your confirmation', 'citytours' ) ?></a>
